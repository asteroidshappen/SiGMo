...
def main():
    ...
    use_as_ICs = str(input(f"Specify which data to base the galaxies on: (SDSS/xCG/GMS/GMS_GAUSS, default: GMS_MHALO_SINGLE)") or "gms_mhalo_single")
    ...
    if (run_sim == "y".casefold()) or (run_sim == "yes".casefold()):
        ...
        # THIS (again) IS FORWARDS INTEGRATION FROM z SET EARLIER, RUNNING UNTIL z=0
        # NORMAL TIME RESOLUTION (but same number of outputs)
        # STELLAR TO HALO MASS SCATTER (sigma=0.1) from input at runtime
